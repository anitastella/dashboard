...
export default function Header() {
  const navigate= useNavigate()
    return (
        ...
        {({ open}) => (
          <>
            <Popover.Button className={(open && 'bg-gray-100',"p-1.5 rounded-sm inline-flex items-center text-gray-700  hover:text-opacity-100 focus: outline-none active:bg-gray-100" )}>
        ...
        >
          <Menu.Items className="origin-top-right z-10 absolute right-0 mt-2 w-48 rounded-sm shadow-md p-1 bg-white ring-1  ring-black ring-opacity-5 focus: outline-none">
              ...
              <Menu.Item>
                {({ active }) => ( 
                <div className={classNames(active && 'bg-gray-50',
                 'text-gray-700 bg-gray-200 cursor-pointer rounded-sm px-4 py-2')}
